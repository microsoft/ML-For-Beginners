...
> **Uma nota sobre testes**: Podes encontrar todos os testes [nesta app](https://gentle-hill-034defd0f.1.azurestaticapps.net/), para um total de 50 testes de 3 perguntas cada. Eles estão vinculados às aulas, mas a aplicação do teste pode ser executada localmente; segue as intruções na pasta `quiz-app`.
