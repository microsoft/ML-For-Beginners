...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T17:25:29+00:00",
...
我們在課程中學習了 [k-means 聚類](../../5-Clustering/2-K-Means/README.md)，但它如何用於解決信用卡詐騙相關的問題呢？
...
醫療保健行業可以利用機器學習來優化研究任務以及解決物流問題，例如患者再入院管理或阻止疾病傳播。
