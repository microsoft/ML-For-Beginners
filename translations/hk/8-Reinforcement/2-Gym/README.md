...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T18:41:59+00:00",
...
✅ 我們可以使用線性插值將值映射到某個有限範圍（例如，從 -20 到 20），然後通過四捨五入將數字轉換為整數。這種方法對狀態大小的控制稍弱，特別是如果我們不知道輸入值的確切範圍。例如，在我們的情況下，4 個值中的 2 個沒有上下界，這可能導致無限的狀態數量。
