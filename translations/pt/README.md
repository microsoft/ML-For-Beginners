...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T08:34:09+00:00",
...
[![ML para iniciantes banner](../../images/ml-for-beginners-video-banner.png)](https://aka.ms/ml-beginners-videos)  
...
|        02       |                A História da aprendizagem automática            |      [Introdução](1-Introduction/README.md)              | Aprenda a história subjacente a este campo                                                                                      |                                            [Lição](1-Introduction/2-history-of-ML/README.md)                                            |                     Jen e Amy                      |  
...
|      14       |                   Introdução à clusterização                   |        [Clusterização](5-Clustering/README.md)     | Limpe, prepare e visualize os seus dados; introdução à clusterização                                                           |         <ul><li> [Python](5-Clustering/1-Visualize/README.md)</li><li>[R](../../5-Clustering/1-Visualize/solution/R/lesson_14.html)         |      <ul><li>Jen</li><li>Eric Wanjau</li></ul>       |
