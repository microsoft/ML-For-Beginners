...
> **Una nota sui quiz**: Tutti i quiz sono contenuti [in questa app](https://gentle-hill-034defd0f.azurestaticapps.net/), per un totale di 50 quiz con tre domande ciascuno. I link ai quiz sono presenti all'interno delle lezioni ma l'app può essere eseguita in locale seguendo le istruzioni contenute nella cartella `quiz-app`.
