...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T10:08:03+00:00",
...
Microsoft 的雲端倡導者很高興提供一個為期 12 週、共 26 節課的課程，內容涵蓋 **機器學習**。在這個課程中，您將學習有時被稱為 **經典機器學習** 的技術，主要使用 Scikit-learn 作為庫，並避免深度學習（深度學習在我們的 [AI 入門課程](https://aka.ms/ai4beginners) 中有涵蓋）。您也可以將這些課程與我們的 ['數據科學入門課程'](https://aka.ms/ds4beginners) 搭配使用！  
...
部分課程提供短片形式的教學。您可以在課程中找到這些影片，或者點擊下方圖片，前往 [Microsoft Developer YouTube 頻道上的 ML 入門播放清單](https://aka.ms/ml-beginners-videos)。  
...
> **關於測驗的說明**：所有測驗都包含在 [測驗應用資料夾](../../quiz-app) 中，共有 52 個測驗，每個測驗包含三個問題。測驗在課程中有連結，但測驗應用可以在本地運行；請按照 `quiz-app` 資料夾中的指示在本地托管或部署到 Azure。  
...
|      09       |                          網頁應用 🔌                          |           [網頁應用](3-Web-App/README.md)            | 建立一個使用您訓練模型的網頁應用                                                                                       |                                                 [Python](3-Web-App/1-Web-App/README.md)                                                  |                         Jen                          |
|      10       |                 分類入門                 |    [分類](4-Classification/README.md)     | 清理、準備並視覺化您的數據；分類入門                                                            | [Python](4-Classification/1-Introduction/README.md) • [R](../../4-Classification/1-Introduction/solution/R/lesson_10.html)  | Jen 和 Cassie • Eric Wanjau |
|      11       |             美味的亞洲和印度美食 🍜             |    [分類](4-Classification/README.md)     | 分類器入門                                                                                                     | [Python](4-Classification/2-Classifiers-1/README.md) • [R](../../4-Classification/2-Classifiers-1/solution/R/lesson_11.html) | Jen 和 Cassie • Eric Wanjau |
...
|      14       |                   分群分析入門                   |        [分群分析](5-Clustering/README.md)         | 清理、準備並視覺化您的數據；分群分析入門                                                                |         [Python](5-Clustering/1-Visualize/README.md) • [R](../../5-Clustering/1-Visualize/solution/R/lesson_14.html)         |      Jen • Eric Wanjau       |
|      15       |              探索尼日利亞的音樂喜好 🎧              |        [分群分析](5-Clustering/README.md)         | 探索 K-Means 分群方法                                                                                           |           [Python](5-Clustering/2-K-Means/README.md) • [R](../../5-Clustering/2-K-Means/solution/R/lesson_15.html)           |      Jen • Eric Wanjau       |
|      16       |        自然語言處理入門 ☕️         |   [自然語言處理](6-NLP/README.md)    | 通過建立一個簡單的機器人來學習 NLP 的基礎知識                                                                             |                                             [Python](6-NLP/1-Introduction-to-NLP/README.md)                                              |                       Stephen                        |
|      17       |                      常見 NLP 任務 ☕️                      |   [自然語言處理](6-NLP/README.md)    | 通過了解處理語言結構時所需的常見任務來加深您的 NLP 知識                          |                                                    [Python](6-NLP/2-Tasks/README.md)                                                     |                       Stephen                        |
|      18       |             翻譯與情感分析 ♥️              |   [自然語言處理](6-NLP/README.md)    | 使用 Jane Austen 進行翻譯與情感分析                                                                             |                                            [Python](6-NLP/3-Translation-Sentiment/README.md)                                             |                       Stephen                        |
...
|  後記   |            使用 RAI 儀表板進行機器學習模型調試          |      [真實世界的機器學習](9-Real-World/README.md)       | 使用負責任 AI 儀表板組件進行機器學習模型調試                                                              |                                             [課程](9-Real-World/2-Debugging-ML-Models/README.md)                                              |                         Ruth Yakubu                       |
