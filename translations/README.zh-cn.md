...
[![宣传视频](ml-for-beginners.zh.png)](https://youtu.be/Tj1XWrDSYJU "宣传视频")
...
|      10       |               分类简介               |    [分类](../4-Classification/translations/README.zh.md)     | 清理、准备和可视化数据； 分类简介                                                            |  [课程](../4-Classification/1-Introduction/README.md)  | Jen 和 Cassie |
|      11       |          美味的亚洲和印度美食 🍜            |    [分类](../4-Classification/translations/README.zh.md)     | 分类器简介                                                                                                     | [课程](../4-Classification/2-Classifiers-1/README.md)  | Jen 和 Cassie |
|      12       |          美味的亚洲和印度美食 🍜            |    [分类](../4-Classification/translations/README.zh.md)     | 更多关于分类器内容                                                                                                                | [课程](../4-Classification/3-Classifiers-2/README.md)  | Jen 和 Cassie |
|      13       |          美味的亚洲和印度美食 🍜            |    [分类](../4-Classification/translations/README.zh.md)     | 使用您的模型构建一个可以「推荐」的 Web 应用                                                                                    |    [课程](../4-Classification/4-Applied/README.md)     |      Jen       |
