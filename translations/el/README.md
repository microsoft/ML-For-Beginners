...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T09:17:43+00:00",
...
**🙏 Ειδικές ευχαριστίες 🙏 στους Microsoft Student Ambassadors συγγραφείς, κριτές και συνεισφέροντες περιεχομένου**, ιδιαιτέρως στους Rishit Dagli, Muhammad Sakib Khan Inan, Rohan Raj, Alexandru Petrescu, Abhishek Jaiswal, Nawrin Tabassum, Ioan Samuila και Snigdha Agarwal  

**🤩 Ιδιαίτερη ευγνωμοσύνη στους Microsoft Student Ambassadors Eric Wanjau, Jasleen Sondhi και Vidushi Gupta για τα μαθήματα R μας!**  
...
- Διαβάστε τη διάλεξη και ολοκληρώστε τις δραστηριότητες, κάνοντας παύση και αναστοχασμό σε κάθε έλεγχο γνώσεων.  
...
Ορισμένα από τα μαθήματα είναι διαθέσιμα ως σύντομα βίντεο. Μπορείτε να τα βρείτε όλα ενσωματωμένα στα μαθήματα ή στη [λίστα αναπαραγωγής ML for Beginners στο κανάλι Microsoft Developer στο YouTube](https://aka.ms/ml-beginners-videos) κάνοντας κλικ στην παρακάτω εικόνα.  
...
Με τη διασφάλιση ότι το περιεχόμενο ευθυγραμμίζεται με έργα, η διαδικασία γίνεται πιο ενδιαφέρουσα για τους μαθητές και η διατήρηση των εννοιών ενισχύεται. Επιπλέον, ένα κουίζ χαμηλού ρίσκου πριν από το μάθημα θέτει την πρόθεση του μαθητή να μάθει ένα θέμα, ενώ ένα δεύτερο κουίζ μετά το μάθημα διασφαλίζει περαιτέρω διατήρηση. Αυτό το πρόγραμμα σπουδών σχεδιάστηκε για να είναι ευέλικτο και διασκεδαστικό και μπορεί να ληφθεί ολόκληρο ή εν μέρει. Τα έργα ξεκινούν μικρά και γίνονται όλο και πιο περίπλοκα μέχρι το τέλος του κύκλου των 12 εβδομάδων. Αυτό το πρόγραμμα σπουδών περιλαμβάνει επίσης ένα επίμετρο για τις εφαρμογές της ML στον πραγματικό κόσμο, το οποίο μπορεί να χρησιμοποιηθεί ως επιπλέον πίστωση ή ως βάση για συζήτηση.  
...
- βίντεο οδηγό (μόνο για ορισμένα μαθήματα)  
- [κουίζ προθέρμανσης πριν από τη διάλεξη](https://ff-quizzes.netlify.app/en/ml/)  
- γραπτό μάθημα  
- για μαθήματα που βασίζονται σε έργα, οδηγούς βήμα προς βήμα για την κατασκευή του έργου  
- ελέγχους γνώσεων  
- μια πρόκληση  
...
> **Σημείωση για τις γλώσσες**: Αυτά τα μαθήματα είναι κυρίως γραμμένα σε Python, αλλά πολλά είναι επίσης διαθέσιμα σε R. Για να ολοκληρώσετε ένα μάθημα R, μεταβείτε στον φάκελο `/solution` και αναζητήστε μαθήματα R. Περιλαμβάνουν μια επέκταση .rmd που αντιπροσωπεύει ένα αρχείο **R Markdown**, το οποίο μπορεί να οριστεί απλά ως ενσωμάτωση `code chunks` (σε R ή άλλες γλώσσες) και μιας `YAML header` (που καθοδηγεί πώς να μορφοποιηθούν οι έξοδοι όπως PDF) σε ένα `Markdown document`. Ως εκ τούτου, χρησιμεύει ως ένα εξαιρετικό πλαίσιο συγγραφής για την επιστήμη δεδομένων, καθώς σας επιτρέπει να συνδυάσετε τον κώδικά σας, την έξοδό του και τις σκέψεις σας γράφοντάς τα σε Markdown. Επιπλέον, τα έγγραφα R Markdown μπορούν να αποδοθούν σε μορφές εξόδου όπως PDF, HTML ή Word.  

> **Σημείωση για τα κουίζ**: Όλα τα κουίζ περιέχονται στον [φάκελο Quiz App](../../quiz-app), για συνολικά 52 κουίζ με τρεις ερωτήσεις το καθένα. Συνδέονται μέσα από τα μαθήματα, αλλά η εφαρμογή κουίζ μπορεί να εκτελεστεί τοπικά. Ακολουθήστε τις οδηγίες στον φάκελο `quiz-app` για τοπική φιλοξενία ή ανάπτυξη στο Azure.  
...
|      03       |                 Δικαιοσύνη και μηχανική μάθηση                 |      [Introduction](1-Introduction/README.md)       | Ποια είναι τα σημαντικά φιλοσοφικά ζητήματα γύρω από τη δικαιοσύνη που πρέπει να εξετάσουν οι μαθητές όταν δημιουργούν και εφαρμόζουν μοντέλα μηχανικής μάθησης; |                                              [Lesson](1-Introduction/3-fairness/README.md)                                               |                        Tomomi                        |
|      04       |                Τεχνικές για μηχανική μάθηση                    |      [Introduction](1-Introduction/README.md)       | Ποιες τεχνικές χρησιμοποιούν οι ερευνητές μηχανικής μάθησης για να δημιουργήσουν μοντέλα μηχανικής μάθησης;                                                        |                                          [Lesson](1-Introduction/4-techniques-of-ML/README.md)                                           |                    Chris και Jen                     |
...
|  Postscript   |            Σενάρια και εφαρμογές μηχανικής μάθησης στον πραγματικό κόσμο |      [ML in the Wild](9-Real-World/README.md)       | Ενδιαφέρουσες και αποκαλυπτικές εφαρμογές της κλασικής μηχανικής μάθησης                                                       |                                             [Lesson](9-Real-World/1-Applications/README.md)                                              |                         Team                         |
|  Postscript   |            Εντοπισμός σφαλμάτων μοντέλων ML με τον πίνακα RAI |      [ML in the Wild](9-Real-World/README.md)       | Εντοπισμός σφαλμάτων στη μηχανική μάθηση χρησιμοποιώντας στοιχεία του πίνακα Responsible AI                                    |                                             [Lesson](9-Real-World/2-Debugging-ML-Models/README.md)                                              |                         Ruth Yakubu                       |
