...
![voronoi diagram](../../../../translated_images/ml/voronoi.1dc1613fb0439b95.png)
...
1. ഓരോ കോളത്തിനും `boxplot()` വിളിച്ച് ഒരു ബോക്സ്‌പ്ലോട്ട് സൃഷ്ടിക്കുക:
    ...
    ![outliers](../../../../translated_images/ml/boxplots.8228c29dabd0f292.png)
...
1. 'എൽബോ മെത്തഡ്' ഉപയോഗിച്ച് ഉറപ്പാക്കുക.
    ...
    ![elbow method](../../../../translated_images/ml/elbow.72676169eed744ff.png)
...
1. മോഡലിന്റെ കൃത്യത പരിശോധിക്കുക:
    ...
    ![clusters](../../../../translated_images/ml/clusters.b635354640d8e4fd.png)
    ...
    ![problem models](../../../../translated_images/ml/problems.f7fb539ccd80608e.png)
