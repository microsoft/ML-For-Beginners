...
1. വ്യത്യാസങ്ങൾ ദൃശ്യവൽക്കരിക്കുക:
    ...
    ![training and testing data](../../../../translated_images/ml/train-test.8928d14e5b91fc94.png)
...
1. ഒറിജിനൽ ഡാറ്റയും സ്കെയിൽ ചെയ്ത ഡാറ്റയും ദൃശ്യവൽക്കരിക്കുക:
    ...
    ![original](../../../../translated_images/ml/original.b2b15efe0ce92b87.png)

    > ഒറിജിനൽ ഡാറ്റ

    ![scaled](../../../../translated_images/ml/scaled.e35258ca5cd3d43f.png)
...
> **🧮 ഗണിതം കാണിക്കുക**
>
> ![MAPE](../../../../translated_images/ml/mape.fd87bbaf4d346846.png)
>
...
1. എന്നാൽ എപ്പോഴും, ഈ തരത്തിലുള്ള കൃത്യതാ അളവ് ദൃശ്യമായി കാണുന്നത് എളുപ്പമാണ്, അതിനാൽ ഇത് പ്ലോട്ട് ചെയ്യാം:
    ...
    ![a time series model](../../../../translated_images/ml/accuracy.2c47fe1bf15f44b3.png)
