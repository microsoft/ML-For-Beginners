...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T09:21:36+00:00",
...
Vi har en Discord-serie om at lære med AI, som kører fra 18. til 30. september 2025. Lær mere og deltag i [Learn with AI Series](https://aka.ms/learnwithai/discord). Her får du tips og tricks til at bruge GitHub Copilot til Data Science.  
...
- Gennemfør opgaven.  
- Efter at have afsluttet en gruppe lektioner, besøg [Diskussionsforummet](https://github.com/microsoft/ML-For-Beginners/discussions) og "lær højt" ved at udfylde den relevante PAT-rubrik. En 'PAT' er et Progress Assessment Tool, som er en rubrik, du udfylder for at fremme din læring. Du kan også reagere på andre PAT'er, så vi kan lære sammen.  
...
> **En note om quizzer**: Alle quizzer er samlet i [Quiz App-mappen](../../quiz-app), i alt 52 quizzer med tre spørgsmål hver. De er linket fra lektionerne, men quiz-appen kan køres lokalt; følg instruktionerne i `quiz-app`-mappen for at hoste lokalt eller udrulle til Azure.  
...
|      17       |                      Almindelige NLP-opgaver ☕️              |   [Naturlig sprogbehandling](6-NLP/README.md)       | Uddyb din NLP-viden ved at forstå almindelige opgaver, der kræves ved arbejde med sproglige strukturer                          |                                                    [Python](6-NLP/2-Tasks/README.md)                                                     |                       Stephen                        |
