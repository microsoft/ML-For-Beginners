...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-01T10:09:51+00:00",
...
[![مرحبًا بالـ PRs](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)

[![المتابعون على GitHub](https://img.shields.io/github/watchers/microsoft/ML-For-Beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ML-For-Beginners/watchers/)
[![Forks على GitHub](https://img.shields.io/github/forks/microsoft/ML-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/ML-For-Beginners/network/)
...
[![خادم Microsoft Foundry في Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
![سلسلة Learn with AI](../../translated_images/ar/3.9b58fd8d6c373c20.png)
...
[![لافتة ML للمبتدئين](../../translated_images/ar/ml-for-beginners-video-banner.63f694a100034bc6.png)](https://aka.ms/ml-beginners-videos)
...
|      05       |                   مقدمة في الانحدار                   |        [الانحدار](2-Regression/README.md)         | ابدأ مع Python و Scikit-learn لنماذج الانحدار                                                                  |         [Python](2-Regression/1-Tools/README.md) • [R](../../2-Regression/1-Tools/solution/R/lesson_1.html)         |      Jen • Eric Wanjau       |
...
|      25       |                 ساعد بيتر على تجنب الذئب! 🐺                  | [التعلم التعزيزي](8-Reinforcement/README.md) | بيئة Gym للتعلم التعزيزي                                                                                                      |                                                [Python](8-Reinforcement/2-Gym/README.md)                                                 |                        Dmitry                        |
