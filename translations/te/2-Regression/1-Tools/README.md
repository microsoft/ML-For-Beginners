...
![Summary of regressions in a sketchnote](../../../../translated_images/te/ml-regression.4e4f70e3b3ed446e.png)
...
![VS Code with a notebook open](../../../../translated_images/te/notebook.4a3ee31f396b8832.jpg)
...
6. ఇప్పుడు డేటాను ప్లాట్‌లో చూపించాల్సిన సమయం. Matplotlib ఈ పనికి చాలా ఉపయోగకరమైన సాధనం. అన్ని X మరియు y టెస్ట్ డేటా యొక్క స్కాటర్‌ప్లాట్ సృష్టించి, అంచనాను ఉపయోగించి మోడల్ డేటా గ్రూపుల మధ్య సరైన చోట లైన్ డ్రా చేయండి.
   ...
   ![a scatterplot showing datapoints around diabetes](../../../../translated_images/te/scatterplot.ad8b356bcbb33be6.png)
