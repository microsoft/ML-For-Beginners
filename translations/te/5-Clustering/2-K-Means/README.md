...
![voronoi diagram](../../../../translated_images/voronoi.1dc1613fb0439b95.te.png)
...
1. ప్రతి కాలమ్ కోసం `boxplot()` పిలిచి బాక్స్‌ప్లాట్ సృష్టించండి:
    ...
    ![outliers](../../../../translated_images/boxplots.8228c29dabd0f292.te.png)
...
1. 'ఎల్బో పద్ధతి' ఉపయోగించి నిర్ధారించండి.
    ...
    ![elbow method](../../../../translated_images/elbow.72676169eed744ff.te.png)
...
1. మోడల్ యొక్క ఖచ్చితత్వాన్ని తనిఖీ చేయండి:
    ...
    ![clusters](../../../../translated_images/clusters.b635354640d8e4fd.te.png)
    ...
    ![problem models](../../../../translated_images/problems.f7fb539ccd80608e.te.png)
