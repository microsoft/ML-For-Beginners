...
1. తేడాలను విజువలైజ్ చేయండి:
    ...
    ![training and testing data](../../../../translated_images/train-test.8928d14e5b91fc94.te.png)
...
1. ఒరిజినల్ మరియు స్కేల్ చేసిన డేటాను విజువలైజ్ చేయండి:
    ...
    ![original](../../../../translated_images/original.b2b15efe0ce92b87.te.png)

    > ఒరిజినల్ డేటా

    ![scaled](../../../../translated_images/scaled.e35258ca5cd3d43f.te.png)
...
> **🧮 గణితం చూపించండి**
>
> ![MAPE](../../../../translated_images/mape.fd87bbaf4d346846.te.png)
>
...
1. కానీ ఎప్పుడూ లాగా, ఈ రకమైన ఖచ్చితత్వ కొలతను దృశ్యంగా చూడటం సులభం, కాబట్టి దీన్ని చిత్రీకరించుకుందాం:
    ...
    ![a time series model](../../../../translated_images/accuracy.2c47fe1bf15f44b3.te.png)
