...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T10:46:31+00:00",
...
|      03       |                 Справедливост и машинно обучение               |      [Въведение](1-Introduction/README.md)          | Какви са важните философски въпроси относно справедливостта, които студентите трябва да разгледат при създаване и прилагане на ML модели? |                                              [Урок](1-Introduction/3-fairness/README.md)                                               |                        Tomomi                        |
...
|      08       |                Цени на тикви в Северна Америка 🎃              |        [Регресия](2-Regression/README.md)           | Създайте логистичен модел на регресия                                                                                           |     [Python](2-Regression/4-Logistic/README.md) • [R](../../2-Regression/4-Logistic/solution/R/lesson_4.html)      |      Jen • Eric Wanjau       |
...
|      23       |  ⚡️ Световно потребление на енергия ⚡️ - прогнозиране с SVR  |        [Времеви серии](7-TimeSeries/README.md)      | Прогнозиране на времеви серии с Support Vector Regressor                                                                        |                                                  [Python](7-TimeSeries/3-SVR/README.md)                                                  |                       Anirban                        |
...
|  Постскриптум |            Дебъгване на модели в ML с RAI табло               |      [ML в реалния свят](9-Real-World/README.md)    | Дебъгване на модели в машинно обучение с компоненти на таблото за отговорен AI                                                  |                                             [Урок](9-Real-World/2-Debugging-ML-Models/README.md)                                              |                         Ruth Yakubu                       |
...
Можете да използвате тази документация офлайн, като използвате [Docsify](https://docsify.js.org/#/). Форкнете този репозитори, [инсталирайте Docsify](https://docsify.js.org/#/quickstart) на вашата локална машина и след това в основната папка на този репозитори въведете `docsify serve`. Уебсайтът ще бъде достъпен на порт 3000 на вашия localhost: `localhost:3000`.
...
Ако имате обратна връзка за продукт или грешки при създаване, посетете:
