...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T10:45:06+00:00",
...
Urmează acești pași:  
1. **Fork Repo-ul**: Apasă pe butonul "Fork" din colțul din dreapta sus al acestei pagini.  
...
> 🎥 Fă clic pe imaginea de mai sus pentru un videoclip despre proiect și despre oamenii care l-au creat!  
...
> Găsiți [Codul nostru de Conduită](CODE_OF_CONDUCT.md), [Contribuții](CONTRIBUTING.md) și [Ghiduri de Traducere](TRANSLATIONS.md). Apreciem feedback-ul vostru constructiv!  
...
| :-----------: | :------------------------------------------------------------: | :-------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------: |  
|      01       |                Introducere în machine learning                |      [Introducere](1-Introduction/README.md)       | Învață conceptele de bază ale machine learning                                                                                  |                                             [Lecție](1-Introduction/1-intro-to-ML/README.md)                                             |                       Muhammad                       |  
|      02       |                Istoria machine learning                        |      [Introducere](1-Introduction/README.md)       | Învață istoria acestui domeniu                                                                                                  |                                            [Lecție](1-Introduction/2-history-of-ML/README.md)                                            |                     Jen și Amy                      |  
...
|      13       |             Bucătării delicioase asiatice și indiene 🍜        |    [Clasificare](4-Classification/README.md)     | Construiți o aplicație web de recomandare folosind modelul vostru                                                               |                                              [Python](4-Classification/4-Applied/README.md)                                              |                         Jen                          |
...
|  Postscript   |            Debugging modele ML folosind tabloul de bord RAI   |      [ML în sălbăticie](9-Real-World/README.md)       | Debugging modele ML folosind componentele tabloului de bord AI responsabil                                                              |                                             [Lecție](9-Real-World/2-Debugging-ML-Models/README.md)                                              |                         Ruth Yakubu                       |
...
Puteți rula această documentație offline folosind [Docsify](https://docsify.js.org/#/). Clonați acest repo, [instalați Docsify](https://docsify.js.org/#/quickstart) pe mașina locală, apoi în folderul rădăcină al acestui repo, tastați `docsify serve`. Website-ul va fi servit pe portul 3000 pe localhost-ul vostru: `localhost:3000`.
