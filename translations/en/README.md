...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T09:57:27+00:00",
...
Join us on a global journey as we apply these techniques to datasets from various regions. Each lesson includes pre- and post-lesson quizzes, step-by-step instructions, solutions, assignments, and more. Our project-based approach ensures you learn by building, a proven method for retaining new skills.  
...
Some lessons are available as short-form videos. You can find them embedded in the lessons or on the [ML for Beginners playlist on the Microsoft Developer YouTube channel](https://aka.ms/ml-beginners-videos) by clicking the image below.  
...
By aligning content with projects, the learning process becomes more engaging, and concept retention improves. Low-stakes quizzes before and after lessons help reinforce learning. The curriculum is designed to be flexible and enjoyable, allowing students to take it in full or in part. Projects start small and grow in complexity over the 12-week cycle. A postscript on real-world ML applications is included for extra credit or discussion.  
...
- written lesson  
- for project-based lessons, step-by-step guides on building the project  
- knowledge checks  
- a challenge  
...
> **A note about languages**: Lessons are primarily written in Python, but many are also available in R. To complete an R lesson, go to the `/solution` folder and look for R lessons. These files have an .rmd extension, representing **R Markdown** documents. R Markdown combines code chunks (R or other languages), a YAML header (for formatting outputs like PDFs), and Markdown text. It’s an excellent framework for data science, allowing you to integrate code, outputs, and commentary. R Markdown documents can be rendered into formats like PDF, HTML, or Word.  

> **A note about quizzes**: All quizzes are located in the [Quiz App folder](../../quiz-app), with 52 quizzes of three questions each. They are linked within the lessons, but the quiz app can be run locally. Follow the instructions in the `quiz-app` folder to host locally or deploy to Azure.  
...
|      03       |                 Fairness and machine learning                  |      [Introduction](1-Introduction/README.md)       | What are the key philosophical considerations regarding fairness that students should keep in mind when developing and applying ML models? |                                              [Lesson](1-Introduction/3-fairness/README.md)                                               |                        Tomomi                        |
